// 94b58093d77e94c1e4d78eaaea8cf2cb
// <auto-generated>
...
namespace GraphQL.TestServer
{
    ...
    [ZeroQL.GraphQLType("IntegerContent")]
    [System.CodeDom.Compiler.GeneratedCode ( "ZeroQL" ,  "1.0.0.0" )]
    public class IntegerContent : PostContent
    {
        [ZeroQL.GraphQLName("id")]
        [JsonPropertyName("id")]
        public int Id { get; set; }
    ...
    public class Query : global::ZeroQL.Internal.IQuery
    {
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        [global::System.ObsoleteAttribute("This property is for internal use only. Do not use it directly. It maybe be removed in the future releases.")]
        public IntegerContent __Integer { get; set; }

        [ZeroQL.GraphQLName("integer")]
        public T Integer<T>(Func<IntegerContent, T> selector = default !)
        {
            return __Integer is null ? throw new NullReferenceException("Integer is null but it should not be null. Schema can be outdated.") : selector(__Integer);
        }
    ...
    internal class ZeroQLPostContentConverter : InterfaceJsonConverter<PostContent?>
    {
        public override PostContent? Deserialize(string typeName, JsonObject json) => typeName switch
        {
            ...
            "IntegerContent" => json.Deserialize<IntegerContent>(ZeroQLJsonOptions.Options),
